...
import com.iwaliner.urushi.common.entiity.food.AburaageFoodEntity;
import com.iwaliner.urushi.common.entiity.food.FoodEntity;
import com.iwaliner.urushi.common.entiity.food.model.AburaageFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class AburaageFoodRenderer<T extends AburaageFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public AburaageFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new AburaageFoodModel<>(context.bakeLayer(ClientSetUp.ABURAAGE));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/aburaage.png");
    }
    ...
    public ResourceLocation getTextureLocation(AburaageFoodEntity p_110775_1_) {
