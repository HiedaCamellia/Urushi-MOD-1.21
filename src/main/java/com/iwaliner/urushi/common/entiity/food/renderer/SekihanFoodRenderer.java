...
import com.iwaliner.urushi.common.entiity.food.SekihanFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class SekihanFoodRenderer<T extends SekihanFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SekihanFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/sekihan.png");
    }
    ...
    public ResourceLocation getTextureLocation(SekihanFoodEntity p_110775_1_) {
