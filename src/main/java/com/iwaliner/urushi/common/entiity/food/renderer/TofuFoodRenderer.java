...
import com.iwaliner.urushi.common.entiity.food.TofuFoodEntity;
import com.iwaliner.urushi.common.entiity.food.model.TofuFoodModel;
...
public class TofuFoodRenderer<T extends TofuFoodEntity> extends EntityRenderer<T> {
    ...
    public TofuFoodRenderer(EntityRendererProvider.Context context) {
        ...
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/tofu.png");
    }
