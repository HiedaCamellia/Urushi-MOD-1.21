...
import com.iwaliner.urushi.common.entiity.food.SalmonSushiFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class SalmonSushiFoodRenderer<T extends SalmonSushiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SalmonSushiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SushiFoodModel<>(context.bakeLayer(ClientSetUp.SUSHI));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/salmon_sushi.png");
    }
    ...
    public ResourceLocation getTextureLocation(SalmonSushiFoodEntity p_110775_1_) {
