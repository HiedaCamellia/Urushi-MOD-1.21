...
import com.iwaliner.urushi.common.entiity.model.GhostModel;
...
public class GhostRenderer extends AbstractGhostRenderer<GhostEntity, GhostModel<GhostEntity>> {
    private static final ResourceLocation TEXTURE_LOCATION = ResourceLocation.parse("urushi:textures/entity/ghost.png");
