...
import com.iwaliner.urushi.common.entiity.food.SalmonRoeSushiFoodEntity;
import com.iwaliner.urushi.common.entiity.food.model.SushiFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class SalmonRoeSushiFoodRenderer<T extends SalmonRoeSushiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SalmonRoeSushiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SushiFoodModel<>(context.bakeLayer(ClientSetUp.SALMON_ROE_SUSHI));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/salmon_roe_sushi.png");
    }
    ...
    public ResourceLocation getTextureLocation(SalmonRoeSushiFoodEntity p_110775_1_) {
