...
import com.iwaliner.urushi.common.entiity.food.KaraageFoodEntity;
import com.iwaliner.urushi.common.entiity.food.model.KaraageFoodModel;
...
public class KaraageFoodRenderer<T extends KaraageFoodEntity> extends EntityRenderer<T> {
    ...
    public KaraageFoodRenderer(EntityRendererProvider.Context context) {
        ...
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/karaage.png");
    }
