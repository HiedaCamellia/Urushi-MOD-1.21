...
import com.iwaliner.urushi.common.entiity.food.TsunaSushiFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class TsunaSushiFoodRenderer<T extends TsunaSushiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public TsunaSushiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SushiFoodModel<>(context.bakeLayer(ClientSetUp.SUSHI));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/tsuna_sushi.png");
    }
    ...
    public ResourceLocation getTextureLocation(TsunaSushiFoodEntity p_110775_1_) {
