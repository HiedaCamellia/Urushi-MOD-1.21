...
import com.iwaliner.urushi.common.entiity.food.TKGFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class TKGFoodRenderer<T extends TKGFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public TKGFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/tkg.png");
    }
    ...
    public ResourceLocation getTextureLocation(TKGFoodEntity p_110775_1_) {
