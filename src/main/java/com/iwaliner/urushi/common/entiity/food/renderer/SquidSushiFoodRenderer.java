...
import com.iwaliner.urushi.common.entiity.food.SquidSushiFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class SquidSushiFoodRenderer<T extends SquidSushiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public SquidSushiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SushiFoodModel<>(context.bakeLayer(ClientSetUp.SUSHI));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/squid_sushi.png");
    }
    ...
    public ResourceLocation getTextureLocation(SquidSushiFoodEntity p_110775_1_) {
