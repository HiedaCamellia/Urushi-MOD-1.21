...
import com.iwaliner.urushi.common.entiity.food.ButadonFoodEntity;
...
public class ButadonFoodRenderer<T extends ButadonFoodEntity> extends EntityRenderer<T> {
    ...
    public ButadonFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new RiceFoodModel<>(context.bakeLayer(ClientSetUp.RICE));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/butadon.png");
    }
    ...
    public ResourceLocation getTextureLocation(ButadonFoodEntity p_110775_1_) {
