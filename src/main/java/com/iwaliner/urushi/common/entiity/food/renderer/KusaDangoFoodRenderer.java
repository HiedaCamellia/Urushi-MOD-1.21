...
import com.iwaliner.urushi.common.entiity.food.KusaDangoFoodEntity;
import com.iwaliner.urushi.common.entiity.food.model.DangoFoodModel;
...
@OnlyIn(Dist.CLIENT)
public class KusaDangoFoodRenderer<T extends KusaDangoFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public KusaDangoFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new DangoFoodModel<>(context.bakeLayer(ClientSetUp.DANGO));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/kusa_dango.png");
    }
    ...
    public ResourceLocation getTextureLocation(KusaDangoFoodEntity p_110775_1_) {
