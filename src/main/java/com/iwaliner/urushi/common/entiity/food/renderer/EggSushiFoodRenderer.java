...
import com.iwaliner.urushi.common.entiity.food.EggSushiFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class EggSushiFoodRenderer<T extends EggSushiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public EggSushiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SushiFoodModel<>(context.bakeLayer(ClientSetUp.SUSHI));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/egg_sushi.png");
    }
    ...
    public ResourceLocation getTextureLocation(EggSushiFoodEntity p_110775_1_) {
