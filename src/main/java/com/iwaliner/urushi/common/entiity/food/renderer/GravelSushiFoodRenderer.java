...
import com.iwaliner.urushi.common.entiity.food.GravelSushiFoodEntity;
...
@OnlyIn(Dist.CLIENT)
public class GravelSushiFoodRenderer<T extends GravelSushiFoodEntity> extends EntityRenderer<T> {

    public static ResourceLocation TEXTURE_LOCATION;
    public static EntityModel<FoodEntity> model ;
    public GravelSushiFoodRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new SushiFoodModel<>(context.bakeLayer(ClientSetUp.SUSHI));
        this.TEXTURE_LOCATION=ResourceLocation.parse("urushi:textures/entity/food/gravel_sushi.png");
    }
    ...
    public ResourceLocation getTextureLocation(GravelSushiFoodEntity p_110775_1_) {
