...
public class MagmaSlabBlock extends SlabBlock {
    ...
    public MagmaSlabBlock(Properties p_56359_) {
        super(p_56359_);
    }
    ...
    public void tick(BlockState p_54806_, ServerLevel p_54807_, BlockPos p_54808_, RandomSource p_54809_) {
    ...
    public void randomTick(BlockState p_54818_, ServerLevel p_54819_, BlockPos p_54820_, RandomSource p_54821_) {
