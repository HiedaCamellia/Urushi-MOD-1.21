...
public class YomiVinesPlantBlock extends CaveVinesPlantBlock {
    public YomiVinesPlantBlock(Properties p_152959_) {
        super(p_152959_);
    }
    ...
    protected GrowingPlantHeadBlock getHeadBlock() {
        return (GrowingPlantHeadBlock) ItemAndBlockRegister.yomi_vines.get();
    }
