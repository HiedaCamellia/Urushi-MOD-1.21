...
public class FoxHopperBlockEntity extends RandomizableContainerBlockEntity implements IFoxHopper {
    ...
    public static final int HOPPER_CONTAINER_SIZE = 27;
    private NonNullList<ItemStack> items = NonNullList.withSize(27, ItemStack.EMPTY);
    private int cooldownTime = -1;
    private long tickedGameTime;

    public FoxHopperBlockEntity(BlockPos p_155550_, BlockState p_155551_) {
    ...
    private static Container getAttachedContainer(Level p_155593_, BlockPos p_155594_, BlockState p_155595_) {
        Direction direction = p_155595_.getValue(FoxHopperBlock.FACING);
        return getContainerAt(p_155593_, p_155594_.relative(direction));
    }

    @Nullable
    private static Container getSourceContainer(Level p_155597_, IFoxHopper p_155598_) {
