...
public class WoodenCabinetryBlockEntity extends RandomizableContainerBlockEntity {
    ...
    private ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            WoodenCabinetryBlockEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
            WoodenCabinetryBlockEntity.this.updateBlockState(p_155064_, true);
        }

        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            WoodenCabinetryBlockEntity.this.playSound(p_155074_, SoundEvents.BARREL_CLOSE);
            WoodenCabinetryBlockEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == WoodenCabinetryBlockEntity.this;
            } else {
                return false;
            }
        }
    };
    public WoodenCabinetryBlockEntity(BlockPos p_155052_, BlockState p_155053_) {
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.woodencabinetry");
    }
