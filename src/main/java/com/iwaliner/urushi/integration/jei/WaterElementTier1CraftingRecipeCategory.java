...
import com.iwaliner.urushi.core.recipe.WaterElementTier1CraftingRecipe;
...
public class WaterElementTier1CraftingRecipeCategory implements IRecipeCategory<WaterElementTier1CraftingRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"water_element_tier1_crafting");
