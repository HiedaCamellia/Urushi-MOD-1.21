...
import com.iwaliner.urushi.core.recipe.ChiseledLacquerLogRecipe;
...
public class ChiseledLacquerLogRecipeCategory implements IRecipeCategory<ChiseledLacquerLogRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"chiseled_lacquer_log");
