...
import com.iwaliner.urushi.core.recipe.WaterElementTier2CraftingRecipe;
...
public class WaterElementTier2CraftingRecipeCategory implements IRecipeCategory<WaterElementTier2CraftingRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"water_element_tier2_crafting");
    ...
    @Override
    public void draw(WaterElementTier2CraftingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
