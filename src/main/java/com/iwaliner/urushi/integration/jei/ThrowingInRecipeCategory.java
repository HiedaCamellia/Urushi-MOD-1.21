...
import com.iwaliner.urushi.core.recipe.ThrowingInRecipe;
...
public class ThrowingInRecipeCategory implements IRecipeCategory<ThrowingInRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"throwing_in");
    ...
    @Override
    public void draw(ThrowingInRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
