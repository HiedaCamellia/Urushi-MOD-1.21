...
import com.iwaliner.urushi.core.recipe.FireElementTier1CraftingRecipe;
...
public class FireElementTier1CraftingRecipeCategory implements IRecipeCategory<FireElementTier1CraftingRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"fire_element_tier1_crafting");
    ...
    @Override
    public RecipeType<FireElementTier1CraftingRecipe> getRecipeType() {
        return JEIUrushiPlugin.JEI_FIRE_ELEMENT_TIER1_CRAFTING;
    }
    ...
    @Override
    public void draw(FireElementTier1CraftingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
