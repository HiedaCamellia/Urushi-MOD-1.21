...
import com.iwaliner.urushi.core.recipe.SandpaperPolishingRecipe;
...
public class SandpaperPolishingRecipeCategory implements IRecipeCategory<SandpaperPolishingRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"polishing");
