...
import com.iwaliner.urushi.core.recipe.FoxEatingRecipe;
...
public class FoxEatingRecipeCategory implements IRecipeCategory<FoxEatingRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"fox_eating");
