...
import com.iwaliner.urushi.core.recipe.HammeringRecipe;
...
public class HammeringRecipeCategory implements IRecipeCategory<HammeringRecipe> {
    public static final ResourceLocation location=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID,"hammering");
    ...
    public RecipeType<HammeringRecipe> getRecipeType() {
        return JEIUrushiPlugin.JEI_HAMMERING;
    }
    ...
    @Override
    public void draw(HammeringRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
